                            ...
                            <div className="flex-1 overflow-hidden shadow bg-white">
                                ...
                                <div className="flex flex-col gap-12 m-4 sm:mx-8 sm:my-6">
                                    ...
                                    <div className="flex flex-col gap-4 mt-4">
                                        ...
                                        <p className="text-sm">This site  has a 'single sign-on' policy. Any changes will reflect in your Seller account also.</p>
                                ...
                                {/* <img draggable="false" className="w-full object-contain" src="" alt="footer" /> */}
                                {/* https://static-assets-web.flixcart.com/www/linchpin/fk-cp-zion/img/myProfileFooter_4e9fe2.png */}
                            </div>
                            {/* <!-- details column --> */}
                        </div>
                    </main>
