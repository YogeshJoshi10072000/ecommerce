  ...
  return (
    ...
    <div id="footer">
      ...
      <div className="midFooter">
        ...
        <p>Copyrights 2022 &copy; Yogesh@Joshi</p>
      </div>

      <div className="rightFooter">
        <h4>Follow Me</h4>
        <a href="https://codeforces.com/profile/Yogesh.Joshi">Codeforces</a>
        <a href="https://www.codechef.com/users/brahmastra123">Codechef</a>
        <a href="https://www.linkedin.com/in/yogesh-joshi-03b47918a/">Linkedin</a>
      </div>
    </div>
  );
};
